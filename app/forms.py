...
from wtforms import StringField,FloatField,TextAreaField,SubmitField,PasswordField,SelectField
...
class EnquiryForm(FlaskForm):
    ...
    country=SelectField("Destination Country",validators=[DataRequired()],choices=[])
